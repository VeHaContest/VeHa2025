...
WriteAction ==
    \E line_num \in TEXT_LINES:
        /\ file[line_num] < ANSWER[line_num]  \** How to compare tuples?
        /\ Write(line_num)
...
\** TLC найдет поведение (если таковое есть), в котором file = ANSWER
NeverSucceed == file # ANSWER
